...
public class BasicJoinHandler implements JoinHandler {
    ...
    public PlayerInteractionHandler joinPlayer(final WebSocket playerConnection) {
        Player player = initPlayer(playerConnection);
     ...
     * @return A new player.
     */
    private Player initPlayer(final WebSocket playerConnection) {
     ...
     */
    private PlayerInteractionHandler initInteractionHandler(final WebSocket playerConnection, final Player player) {
     ...
     */
    private void leavePlayer(final Player player, final WebSocket connection) {
